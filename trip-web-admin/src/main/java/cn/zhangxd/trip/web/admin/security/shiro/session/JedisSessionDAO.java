//package cn.zhangxd.trip.web.admin.security.shiro.session;
//
...
//				if (StringHelper.isNotBlank(e.getKey()) && StringHelper.isNotBlank(e.getValue())){
//
//					String[] ss = StringHelper.split(e.getValue(), "|");
...
//				}
//				// 存储的SESSION无Value
//				else if (StringHelper.isNotBlank(e.getKey())){
//					jedis.hdel(sessionKeyPrefix, e.getKey());
//				}
//			}
