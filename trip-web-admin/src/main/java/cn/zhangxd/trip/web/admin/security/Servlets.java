...
public class Servlets {
	...
	public static String encodeHttpBasic(String userName, String password) {
		...
		return "Basic " + EncodeHelper.encodeBase64(encode.getBytes());
	}
...
//	}
    ...
    public static boolean isStaticFile(String uri){
		...
		if (StringHelper.endsWithAny(uri, staticFiles) && !StringHelper.endsWithAny(uri, urlSuffix)
				&& !StringHelper.endsWithAny(uri, ".jsp") && !StringHelper.endsWithAny(uri, ".java")){
			return true;
		}
		return false;
    }
