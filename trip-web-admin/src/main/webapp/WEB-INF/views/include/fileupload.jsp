<link rel="stylesheet" href="${ctxStatic}/blueimp/css/blueimp-gallery.min.css">
...
<script src="${ctxStatic}/jquery-fileupload/js/vendor/jquery.ui.widget.js"></script>
<script src="${ctxStatic}/blueimp/js/load-image.min.js"></script>
<script src="${ctxStatic}/blueimp/js/canvas-to-blob.min.js"></script>
<script src="${ctxStatic}/blueimp/js/jquery.blueimp-gallery.min.js"></script>
...
<!--[if (gte IE 8)&(lt IE 10)]><script src="${ctxStatic}/jquery-fileupload/js/cors/jquery.xdr-transport.js"></script><![endif]-->